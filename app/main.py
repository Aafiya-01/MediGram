...
def main():
    ...
    with st.container():
        ...
        st.write("Cancer diagnosis often involves the examination of cellular samples obtained through cytology procedures. By integrating our ML application with our cytology lab, we create a comprehensive and efficient workflow that maximizes accuracy and speed in detecting cancer.")
